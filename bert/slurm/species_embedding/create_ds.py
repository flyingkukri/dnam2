...
def create_species_embed_ds(dataset):
    ...
    updated_dataset = updated_dataset.add_column("species_id", species_ids)
    print('added new species embedding column to the dataset')
    return updated_dataset

updated_dataset = create_species_embed_ds(dataset)

updated_dataset.save_to_disk("../../batch_embed")
print("saved to disk")
